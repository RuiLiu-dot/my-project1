...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_lib_selector_type_script_index_0_bustCache_Edit_vue__ = __webpack_require__(236);
/* empty harmony namespace reexport */
var disposed = false
var normalizeComponent = __webpack_require__(4)
/* script */
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-785d952b", Component.options)
  } else {
    hotAPI.reload("data-v-785d952b", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__v_product_Create__ = __webpack_require__(227);
//


/* harmony default export */ __webpack_exports__["a"] = ({
    mixins: [__WEBPACK_IMPORTED_MODULE_0__v_product_Create__["default"]],
    data() {
        return {
            title: '编辑商品',
    ...
    methods: {
        ...
        getData() {
            ...
            this.$http.get('admin/product/detail', { params }).then(({ data }) => {
                // console.log(data)
                if (data.error === 0) {
                    this.data = data.data;
                } else {
